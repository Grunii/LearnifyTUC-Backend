                    ...
                    rules={[
                        {
                            min: 10,
                            message:
                                "SubTitle Should have at least 10 characters",
                        },
                        {
                            required: true,
                            message:
                                "Please mention the subTitle of the course",
                        },
                    ]}
                >
                    <Input
                ...
                <Form.Item
                    ...
                    rules={[
                        ...
                        },
                        {
                            required: true,
                            message:
                                "Please mention the description of the course",
                        },
                    ]}
                >
                    <Input.TextArea
                    ...
                    rules={[
                        {
                            required: true,
                            message:
                                "Please mention the category of the course",
                        },
                    ]}
                >
                    <Select
